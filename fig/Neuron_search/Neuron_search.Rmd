...
library(mixOmics)
knit_hooks$set(custom.plot = hook_rgl2) #Needed to embed plots
...
par3d(op)
plot3d("FruMARCM-M001629_seg001", col='black', lwd=2, soma=T)
```
...
```{r TopHitsMeanScore, fig.width=60.156/25.4*5, fig.height=60.325/25.4*5, cache=TRUE}
...
```{r SimilarNeuronType, fig.width=116.064/25.4*5, fig.height=60.591/25.4*5, cache=TRUE}
